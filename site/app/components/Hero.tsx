    ...
    <section className="flex flex-col items-center px-6 pt-32 pb-24 text-center">
      ...
      <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
        <div className="flex items-center gap-2 rounded-lg bg-code-bg px-5 py-3 font-mono text-sm">
          ...
          <code>cargo install tinyspec</code>
        </div>
        <a
          href="https://github.com/nmcdaines/tinyspec"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-lg border border-border px-5 py-3 text-sm font-medium transition-colors hover:bg-code-bg"
        >
          <svg
            className="h-5 w-5"
            fill="currentColor"
